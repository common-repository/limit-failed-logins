...
class LFLR_cidr_check {

    public function lfl_match($ip, $cidr) {
        ...
        return $this->lfl_IPv4Match($ip, $subnet, $mask);
    }

    private function lfl_IPv4Match($address, $subnetAddress, $subnetMask) {
